				...
				<form class="card-body shadow-lg bg-body-tertiary rounded" id="top">
					<div class="row">
						<div class="form-group col-md-3">
							<label for="trainingReferenceId" class="form-label">RefPlannerID<span class="required-field">*</span></label>
							<div class="form-floating">
								<input type="text" class="form-control" id="trainingReferenceId" style="font-size: 20px;">
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="form-floating">
						...
						<div class="form-group col-md-3">
							<div class="form-group" id="venueName">
								<label for="venueName">Venue Name:<span class="required-field">*</span></label> <select
									id="venueDropdown" class="form-control" required></select>
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="form-group" id="resourceType">
								<label for="resource">Resource Type:<span class="required-field">*</span></label> <select
						...
						<div class="form-group col-md-3">
							<div class="form-floating">
								<input type="Date" class="form-control" id="applicationED"
									...
									for="applicationED">Application End Date<span class="required-field">*</span></label>
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="form-floating">
								<input type="Date" class="form-control" id="trainingSD"
									...
									for="trainingSD">Training Start Date<span class="required-field">*</span></label>
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="form-floating">
								<input type="time" class="form-control" id="starttime"
									placeholder="12343215" required> <label
									for="starttime">Training Start Time<span class="required-field">*</span></label>
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="form-floating">
								<input type= "Date" class="form-control" id="trainingED"
									placeholder="12343215" required> <label
									for="trainingED">Training End date<span class="required-field">*</span></label>
							</div>
						</div>
						<div class="form-group col-md-3">
							<div class="form-floating">
								<input type="time" class="form-control" id="endtime"
									placeholder="12343215" required> <label
									for="endtime">Training End Time<span class="required-field">*</span></label>
							</div>
						</div>
					</div>
					<div class="row mt-2">
